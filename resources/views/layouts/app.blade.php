            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        {{-- <a href="{{ url(route('home') . '#about us') }}" class="nav-item nav-link">About</a> --}}
                        <a href="{{ route('services') }}" class="nav-item nav-link">Service</a>
                        {{-- <a href="{{ url(route('home') . '#service') }}" class="nav-item nav-link">Service</a> --}}
                        <a href="{{ route('foods.menu') }}" class="nav-item nav-link">Menu</a>
                        {{-- <a href="{{url(route('home') . '#menu')}}" class="nav-item nav-link">Menu</a> --}}
                        ...
                        {{-- <a href="{{ url(route('home') . '#contact') }}" class="nav-item nav-link">Contact</a> --}}
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="{{ url(route('home') . '#about us') }}">About Us</a>
                    <a class="btn btn-link" href="{{ url(route('home') . '#contact') }}">Contact Us</a>
                    <a class="btn btn-link" href="{{ url(route('home') . '#bookTable') }}">Reservation</a>
